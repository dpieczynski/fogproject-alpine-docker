#!/bin/bash
######## Variables                                                                                                                                                           [  started  ]
Services=$(echo mariadb nginx php-fpm7 in.tftpd rpcbind nfs nginx vsftpd FOGImageReplicator FOGImageSize FOGMulticastManager  FOGPingHosts FOGScheduler FOGSnapinHash FOGSnapinReplicator)
